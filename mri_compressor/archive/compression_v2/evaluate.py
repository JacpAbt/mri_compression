...
Usage:
  python evaluate_model.py quick --model ./compressed_v2_safe/model
  python evaluate_model.py bench --model ./compressed_v2_safe/model
  python evaluate_model.py bench --model ./compressed_v2_safe/model --tasks arc_challenge,hellaswag
  python evaluate_model.py compare --original Qwen/Qwen2.5-3B --compressed ./compressed_v2_safe/model
  python evaluate_model.py compare-quick --original Qwen/Qwen2.5-3B --compressed ./compressed_v2_safe/model --generate
"""
